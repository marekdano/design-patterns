 ...
 * This is usually done when new implementations or code refactoring (done for reasons like performance gains)
 * result in a different public API while the other parts of the system are still using the old API and 
 * hence needs to be adapted to work together.
 * 
 ...
 * The Adapter class CalcAdapterwraps the NewCalculator to add the operation method to the public facing API 
